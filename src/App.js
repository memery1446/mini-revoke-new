                    ...
                    <div className="col-lg-4">
                        <div className="card mb-4 shadow-sm">
                            ...
                            <div className="card-body">
                                <div className="mb-3">
                                    ...
                                    <code>{wallet.substring(0, 8)}...{wallet.substring(wallet.length - 6)}</code>
                                </div>
                                <div className="mb-3">
                                ...
                                <div className="mb-3">
                                    <span className="fw-bold d-block mb-1">Status:</span>
                                    {isHardhatNetwork ? (
                        ...
                        <div className="card border-danger mb-4 shadow-sm">
                            ...
                            <div className="card-body">
                                <div className="alert alert-warning">
                                    <small>
                                        <strong>Warning:</strong> This will revoke ALL token approvals.
                                ...
                                <button 
                                    ...
                                    disabled={revokeLoading || !isHardhatNetwork}
                                >
                                    {revokeLoading ? (
                                        <>
                        ...
                        <div className="card shadow-sm">
                            <div className="card-header bg-light">
                                <h4 className="card-title mb-0">App Info</h4>
                            </div>
                            <div className="card-body">
                                <p className="card-text">
                                    Mini Revoke Cash helps you maintain control of your token allowances.
                                    Revoke unwanted approvals to improve your wallet security.
                                </p>
                                <div className="d-grid gap-2">
                                    <button className="btn btn-outline-primary" type="button" onClick={() => setActiveTab("dashboard")}>
                                        View Dashboard
                                    </button>
                                </div>
                            </div>
                            <div className="card-footer text-muted">
                                <small>Running on Hardhat {isHardhatNetwork && '✓'}</small>
                            </div>
                        </div>
                    </div>
                </div>
