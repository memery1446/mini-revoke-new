...
import { getERC721Approvals } from "../utils/nftApprovals"; // ✅ Import ERC-721 fetching
import { getERC1155Approvals } from "../utils/erc1155Approvals"; // ✅ Import ERC-1155 fetching
...
useEffect(() => {
    ...
    console.log("📌 Redux Approvals State:", approvals); // 🛠️ Log Redux approvals
...
const fetchApprovals = async () => {
    try {
        ...
        const erc721Fetched = await getERC721Approvals(account); // ✅ Fetch ERC-721 approvals
        console.log("✅ ERC-721 Approvals Fetched:", erc721Fetched);

        console.log("🔄 Fetching ERC-1155 approvals...");
        const erc1155Fetched = await getERC1155Approvals(account); // ✅ Fetch ERC-1155 approvals
